...
export async function createInvoice(
  ...
  autoTable(doc, {
    ...
    body: [
      [
        "\u2022 DropCargo Express aplica cargos por peso o volumen para cargas extra dimensionada.",
      ],
      [
        "\u2022 DropCargo Express no se hará responsable por daño en mercancia mal empacada por exportación.",
      ],
      [
        "\u2022 DropCargo Express no se hace responsable por mercancia extraviada entregada por USPS.",
      ],
      [
        "\u2022 DropCargo Express no se hace responsable por paquetes, despues de 1 mes de no ser retirado en la oficina.",
      ],
    ],
    headStyles: {
      fontSize: 13,
